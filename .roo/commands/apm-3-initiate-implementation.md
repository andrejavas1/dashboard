...
2. **Read .roo/commands/apm-8-delegate-debug.md** - Follow the guide exactly
...
1. **Create Prompt:** Read and follow the appropriate delegation command from:
  - .roo/commands/apm-8-delegate-debug.md for debugging issues
  - .roo/commands/apm-7-delegate-research.md for information gathering
