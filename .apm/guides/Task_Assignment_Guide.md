...
[Manager fills this section with section §7 content guidance, including explicit command references for Debug/Research delegations (.roo/commands/apm-8-delegate-debug.md or .roo/commands/apm-7-delegate-research.md)]
```
...
- **Debug Delegation**: Reference .roo/commands/apm-8-delegate-debug.md
- **Research Delegation**: Reference .roo/commands/apm-7-delegate-research.md  
