...
**Content Definition:**
- If flagged in §4.1, first add an ad-hoc delegation step: "Ad-Hoc Delegation – <purpose>" (optional ref to .roo/commands/apm-7-delegate-research.md or .roo/commands/apm-8-delegate-debug.md), then continue
...
2. **If User skips Review:** Proceed directly to **Manager Bootstrap Creation**.
  - **CRITICAL:** You must generate the Bootstrap Prompt using the **EXACT TEMPLATE** defined in your initiation prompt .roo/commands/apm-1-initiate-setup.md.
  - **Context Recovery:** If you cannot retrieve the template word-for-word from your context, you must **READ** the .roo/commands/apm-1-initiate-setup.md file to refresh your memory before generating the prompt. Do not approximate the template.
