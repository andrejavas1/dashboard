...
def run_full_pipeline():
    ...
    try:
        ...
        try:
            ...
            # Step 2: Generate dashboard patterns.json
            logger.info("Generating dashboard patterns data...")
            import generate_dashboard_patterns
            generate_dashboard_patterns.convert_optimized_to_dashboard_format()
            logger.info("Dashboard patterns data generated")
            
            # Step 3: Generate occurrence files
            logger.info("Generating pattern occurrence files...")
            import generate_all_occurrence_files
            generate_all_occurrence_files.generate_all_occurrence_data()
            logger.info("Pattern occurrence files generated")
            
            # Step 4: Generate standalone HTML dashboard
            logger.info("Generating standalone HTML dashboard...")
            import standalone_dashboard as dashboard
            dashboard.generate_standalone_html()
            logger.info("HTML Dashboard generated successfully: PATTERN_DASHBOARD.html")
            logger.info("Open PATTERN_DASHBOARD.html in your browser - no server required!")
